...
const userSchema = new Schema<IUser, UserInterface>(
  {
    ...
    isBecomeCook: { type: Boolean, default: false },
    ...
    isCookfullyVerified: { type: Boolean, default: false },
    isCookPdf: { type: Boolean, default: false },
    isCookVideo: { type: Boolean, default: false },
